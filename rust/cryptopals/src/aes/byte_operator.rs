...
const RIJNDAEL_S_BOX_FORWARD: [u8; 256] = [
...
const RIJNDAEL_S_BOX_INVERSE: [u8; 256] = [
...
pub fn sub_byte(input: u8) -> u8 {
    RIJNDAEL_S_BOX_FORWARD[input as usize]
}

pub fn inverse_sub_byte(input: u8) -> u8 {
    RIJNDAEL_S_BOX_INVERSE[input as usize]
}
