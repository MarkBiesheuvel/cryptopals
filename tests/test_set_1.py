...
def test_challenge_01() -> None:
    plaintext_1: Text = Text.from_hexadecimal(
        '49276d206b696c6c696e6720796f757220627261696e206c696b65206120706f69736f6e6f7573206d757368726f6f6d'
    )
    plaintext_2: Text = Text.from_base64('SSdtIGtpbGxpbmcgeW91ciBicmFpbiBsaWtlIGEgcG9pc29ub3VzIG11c2hyb29t')

    assert plaintext_1 == plaintext_2


def test_challenge_02() -> None:
    plaintext_1: Text = Text.from_hexadecimal('1c0111001f010100061a024b53535009181c')
    plaintext_2: Text = Text.from_hexadecimal('686974207468652062756c6c277320657965')
    ciphertext: Text = Text.from_hexadecimal('746865206b696420646f6e277420706c6179')

    assert plaintext_1.fixed_xor(plaintext_2) == ciphertext


def test_challenge_03() -> None:
    ciphertext: Text = Text.from_hexadecimal('1b37373331363f78151b7f2b783431333d78397828372d363c78373e783a393b3736')
    plaintext: Text = Text.from_ascii('Cooking MC\'s like a pound of bacon')

    assert brute_force_single_byte_xor([ciphertext]) == plaintext


def test_challenge_04() -> None:
    ciphertexts: Iterable[Text] = (
        Text.from_hexadecimal(line)
        for line in file_iterator('tests/data/4.txt')
    )
    plaintext: Text = Text.from_ascii('Now that the party is jumping\n')
...
def test_challenge_05() -> None:
    key: bytes = b'ICE'
    plaintext: Text = Text.from_ascii('Burning \'em, if you ain\'t quick and nimble\nI go crazy when I hear a cymbal')
    ciphertext: Text = Text.from_hexadecimal(
        '0b3637272a2b2e63622c2e69692a23693a2a3c6324202d623d63343c2a26226324272765272'
        'a282b2f20430a652e2c652a3124333a653e2b2027630c692b20283165286326302e27282f'
    )

    assert plaintext.repeating_key_xor(key) == ciphertext


def test_challenge_06() -> None:
    plaintext_1: Text = Text.from_ascii('this is a test')
    plaintext_2: Text = Text.from_ascii('wokka wokka!!!')

    assert plaintext_1.hamming_distance(plaintext_2) == 37

    ciphertext: Text = Text.from_base64(file_as_string('tests/data/6.txt'))
...
def test_challenge_08() -> None:
    ...
    ecb_ciphertext: Text = Text.from_hexadecimal(
