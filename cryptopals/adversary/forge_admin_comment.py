...
# Using a bitflip mask of 0b00001000 will turn ';' into '3' and '=' into '5' and vice versa
MASK: int = 0b00001000


def forge_admin_comment(oracle: Oracle) -> Ciphertext:
    # Try to be extra clever by entering userdata that might bitflip into the admin=true property
    ...
    # TODO: Caculate position of the start of our plainttext minus 1 block
