...
class Text:
    ...
    def encrypt_ebc_mode(self, key: bytes) -> Text:
    ...
    def decrypt_ecb_mode(self, key: bytes) -> Text:
        stream = AES.new(key, AES.MODE_ECB)
        return Text(
    ...
    def encrypt_cbc_mode(self, key: bytes, iv: bytes) -> Text:
    ...
    def decrypt_cbc_mode(self, key: bytes, iv: bytes) -> Text:
        stream = AES.new(key, AES.MODE_CBC, iv=iv)
        return Text(
            stream.decrypt(self.to_bytes()),
            self.block_size
